...
<svelte:head>
	<title>Register - Brads Spelcafe</title>
</svelte:head>
...
<main class="min-h-screen flex items-center justify-center bg-brads-yellow-light py-12 px-4">
	<div class="max-w-sm w-full">
		...
		>
			...
			<div>
				<label for="email" class="block font-londrina text-lg text-brads-green-dark mb-1">
					Email <span class="text-brads-green-dark/40">(optional)</span>
				</label>
				<input
					id="email"
					name="email"
					...
					class="w-full border border-gray-300 rounded-lg px-4 py-2 font-londrina text-lg focus:outline-none focus:ring-2 focus:ring-brads-green-light"
				/>
				<p class="text-sm text-gray-400 font-londrina mt-0.5">Only used if you need a password reset</p>
			</div>
			...
			<div>
				<label for="confirmPassword" class="block font-londrina text-lg text-brads-green-dark mb-1">
					Confirm Password
				</label>
				<input
					id="confirmPassword"
		...
		<p class="text-center mt-4 font-londrina text-lg text-brads-green-dark/60">
			...
			<a href="/login" class="text-brads-green-dark underline hover:text-brads-green-light">
				Log in
			</a>
		</p>

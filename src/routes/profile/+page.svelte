...
<div class="min-h-screen bg-brads-yellow-light py-8">
	<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
		<!-- Header -->
		<div class="bg-white shadow rounded-xl px-6 py-6 border border-brads-green-light/20">
			<h1 class="text-3xl font-londrina text-brads-green-dark">Profile Settings</h1>
			<p class="mt-1 text-brads-green-dark/60 font-londrina text-lg">
				Manage your account and party finder preferences
			</p>
		</div>

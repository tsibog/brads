...
<div class="bg-brads-yellow-light min-h-screen font-londrina">
	...
	<footer class="bg-brads-green-dark text-white text-center py-4">
		<p class="text-sm">
			Made for Brads Spelcaf&eacute; by Daniel Andersson
			<a
				href="https://github.com/tsibog"
				target="_blank"
				rel="noopener noreferrer"
				class="inline-flex items-center gap-1 ml-1 hover:text-brads-yellow-light transition-colors"
			...
			<a
				href="https://www.linkedin.com/in/dan1el-andersson"
				target="_blank"
				rel="noopener noreferrer"
				class="inline-flex items-center gap-1 ml-1 hover:text-brads-yellow-light transition-colors"

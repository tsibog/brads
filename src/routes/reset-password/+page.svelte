...
<svelte:head>
	<title>Set New Password - Brads Spelcafe</title>
</svelte:head>

<main class="min-h-screen flex items-center justify-center bg-brads-yellow-light py-12 px-4">
	<div class="max-w-sm w-full">
		<div class="text-center mb-8">
			<h1 class="text-4xl font-londrina text-brads-green-dark">Set a New Password</h1>
			<p class="text-lg font-londrina text-brads-green-dark/60 mt-1">
				Hi {data.username}, your password was reset. Please choose a new one.
			</p>
		</div>
